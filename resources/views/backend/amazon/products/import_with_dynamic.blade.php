        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <form method="POST" action="{{route('amazon-products.import.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="amazon_sub_category_id">Select Sub-Category</label>
                        <select name="amazon_sub_category_id" id="amazon_sub_category_id" class="form-control @error('amazon_sub_category_id') is-invalid @enderror" disabled>
