...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary float-left">Import Blog Products</h6>
        <a href="{{route('blog-products.index')}}" class="btn btn-secondary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Back to Products">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <!-- Upload Form -->
                <form method="POST" action="{{route('blog-products.import.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="blog_sub_category_id">Select Sub-Category</label>
                        <select name="blog_sub_category_id" id="blog_sub_category_id" class="form-control @error('blog_sub_category_id') is-invalid @enderror" disabled>
                            <option value="">-- Choose Sub-Category --</option>
                        </select>
                        <small class="form-text text-muted">Optional: Select a subcategory to import products into specific subcategory</small>
                    ...
                    <div class="form-group">
                        ...
                        <!-- Download Sample -->
                        <a href="{{asset('templates/blog_products_sample.csv')}}" class="btn btn-info btn-sm" download>
                ...
                <div>
                    ...
                    <ol>
                        ...
                        <li>Optionally select a subcategory for more specific categorization.</li>
                        <li>Prepare a CSV file with the following columns in order:</li>
                        <ul>
                            <li><strong>Product Name</strong> (required)</li>
                            <li><strong>Description</strong> (optional)</li>
                            <li><strong>Link</strong> (optional - product link)</li>
                        ...
                        <li>All products will be imported into the selected category and subcategory (if chosen).</li>
                        <li>Duplicate product names in the same category/subcategory will be skipped.</li>
