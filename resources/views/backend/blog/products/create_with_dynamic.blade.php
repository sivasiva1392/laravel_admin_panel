...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Add Blog Product</h6>
    </div>
    <div class="card-body">
        <form method="POST" action="{{route('blog-products.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="url" name="link" id="link" class="form-control @error('link') is-invalid @enderror" value="{{old('link')}}" placeholder="Enter external link (e.g., product URL)" maxlength="500">
