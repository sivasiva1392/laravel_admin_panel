...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary float-left">Import Blog Categories</h6>
        <a href="{{route('blog-categories.index')}}" class="btn btn-secondary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Back to Categories">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <!-- Upload Form -->
                <form method="POST" action="{{route('blog-categories.import.store')}}" enctype="multipart/form-data">
                    @csrf
                ...
                <!-- <div class="text-center mb-4"> -->
                    <a href="{{asset('templates/blog_categories_sample.csv')}}" class="btn btn-info btn-sm" download>
