            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        @if($category->image)
                            <small class="form-text text-info">Current image: <img src="{{asset('uploads/blog/'.$category->image)}}" class="img-fluid" style="max-width:100px" alt="{{$category->category_name}}"></small>
                        @endif
                        @error('image')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
