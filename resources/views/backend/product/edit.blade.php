      ...
      <form method="post" action="{{route('product.update',$product->id)}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="mb-3">
              ...
              <div>
                  <img src="{{url($product->photo)}}" style="max-width: 200px; max-height: 100px; border: 1px solid #ddd; border-radius: 4px;"/>
              </div>
          </div>
          @endif
...
<script>
    $(document).ready(function() {
        console.log('Initializing Summernote for product edit...');
        ...
        console.log('Product edit Summernote initialized successfully!');
