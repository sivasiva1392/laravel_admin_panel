      ...
      <div class="form-group {{(($category->is_parent==1) ? 'd-none' : '')}}" id='parent_cat_div'>
        ...
        <div class="form-group">
          ...
          <div class="mb-3">
              ...
              <div>
                  <img src="{{url($category->photo)}}" style="max-width: 200px; max-height: 100px; border: 1px solid #ddd; border-radius: 4px;"/>
              </div>
          </div>
          @endif
...
<script>
    $(document).ready(function() {
        console.log('Initializing Summernote for category edit...');
        ...
        console.log('Category edit Summernote initialized successfully!');
